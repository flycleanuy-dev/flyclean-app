...
export const MAP = {
  ...
  propuestas: (props, page) => ({
    ...
    aviso_recontacto: check(props, 'Aviso re-contacto'), mapa: url(props, 'Mapa'),
  ...
  servicios: (props, page) => ({
    ...
    fecha_programada: date(props, 'Fecha programada'), fecha_planificada: date(props, 'Fecha planificada'),
