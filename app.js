...
const TRANSLATIONS = {
  'es': {
    ...
    'consent.body': 'Para usar FlyClean necesitás aceptar nuestros Términos de Uso y la Política de Privacidad.',
    ...
    'hist.sub': 'Los servicios en los que participaste. Solo lectura — acá no se puede tocar nada, solo tu nota.',
    'hist.mes': 'Este mes',
    'hist.total': 'Total',
    ...
    'miseq.sub': 'Una vez por semana (antes del viernes): cargá el total del contador y avisá si hay algo para notar.',
    ...
    'ayuda.ph': '¿Cómo hago…?',
    'ayuda.welcome': '¡Hola! Soy tu asistente. Preguntame cómo hacer cualquier cosa en la app y te guío paso a paso. 🙂',
    ...
    'eq.delete.hint': 'Sale de la lista, recuperable 30 días. Para apartarlo sin borrar, usá el estado "Fuera de servicio".',
    'eq.delete.confirm': 'Eliminar "{name}" de los equipos. Va a la papelera (recuperable 30 días). ¿Eliminar?',
    'hist.stat.contiempo': 'Con tiempo registrado: {n} de {m} servicios.',
    'hist.stat.hint': 'El tiempo se registra cuando el operario aprieta ▶ Iniciar y al finalizar — los servicios viejos sin ese registro no suman. 🚁 Dron usa el Método de trabajo del servicio.',
    ...
    'cfg.reglas.hint': 'Aplican al instante en la app; los avisos automáticos los toman en su próxima corrida diaria.',
    ...
    'cfg.wa.hint': 'Comodines: {n} = nombre de la persona · {prop} = nombre de la propuesta (solo en Seguimiento).',
    ...
    'cfg.tar.hint': 'Precio de UN jornal (una persona, un día) por método. Se multiplica por los jornales del mes.',
    ...
    'cfg.tar.paisnote': 'Suma todos los países del mes (moneda local). Al activar otro país se separará por moneda.',
    ...
    'calc.dron': 'Dron',
    'calc.manual': 'Manual',
    'calc.result': 'Precio sugerido para {m2} m² ({metodo}): {precio}\n\nQuedó cargado en el importe (podés ajustarlo).',
    ...
    'services.empty.text': 'Pedile al coordinador que te asigne un servicio. Los servicios aparecen aquí cuando el coordinador te los asigna.',
    ...
    'cancelar.inicio.confirm': '¿Cancelar el inicio del servicio? Vas a tener que volver a iniciar cuando corresponda.',
    'cancelar.inicio.blocked': 'Ya registraste el inicio efectivo del trabajo. No se puede cancelar (hay datos del trabajo en curso).',
    'close.need.resultado': 'Marcá un resultado (Exitoso / Con incidencia / Fallido) antes de cerrar.',
    'close.prueba.need.resultado': 'Marcá un resultado de la prueba (Avanza / No interesado / Re-contactar) antes de cerrar.',
    ...
    'step.metodo.hint': 'Elegí cómo se hace el trabajo — podés marcar uno o ambos (dron y manual) y varias herramientas. Obligatorio para registrar el inicio efectivo.',
    ...
    'sheet.edit.delete.confirm.completed': 'El servicio "{name}" está COMPLETADO (registro histórico). ¿Eliminarlo igual? Va a la papelera (recuperable 30 días).',
    ...
    'wa.msg.prop': 'Hola{n}, te escribimos de FlyClean por el presupuesto "{prop}". ¿Pudiste verlo? Cualquier duda estamos a las órdenes 🚁',
    'wa.msg.prospecto': 'Hola{n}, somos FlyClean: limpieza de fachadas, vidrios y paneles con drones. ¿Podemos contarte cómo trabajamos? 🚁',
    ...
    'finanzas.tab.reportes': '📊 Reportes',
    'finanzas.gastos.empty': '💸 Cargá un gasto con la foto del recibo — la IA (Claude) extrae los datos automáticamente.',
    ...
    'sheet.edit.section.participantes.hint': 'Marcá a los que estuvieron en el campo además del piloto. Cada uno suma 1 jornal.',
    ...
    'sheet.edit.section.mapa.hint': "Pegá el link de Google Maps (botón 'Compartir' → 'Copiar link'). El operario abre Maps/Waze directo.",
    ...
    'sheet.contact.recontacto.hint': 'Hasta esta fecha el cliente no aparece en "para recontactar" ni en las alertas. Vacío = ciclo normal (9 meses).',
    'sheet.prop.section.posponer': '⏸ POSPONER AVISO HASTA',
    'sheet.prop.posponer.hint': 'Hasta esta fecha la propuesta no aparece en "A contactar hoy" ni la mueve el robot. Vacío = ciclo normal (15/45 días).',
    'coord.prop.pospuesta': 'Avisos pospuestos hasta el {f}',
    'wa.msg.cliente': 'Hola{n}, te escribimos de FlyClean 🚁 ¿Coordinamos una limpieza de fachada, vidrios o paneles? Estamos a las órdenes.',
    ...
    'prosp.confirm.cliente': '¿Marcar este prospecto como Cliente activo? Sale de Prospección y pasa a tu cartera de clientes.',
    ...
    'comms.sub': 'El sistema de mensajería interno entre CEO, coordinadores y operarios está en desarrollo. Próximamente podrán comunicarse directamente desde la app.',
    'comms.badge': 'Próximamente',
    'comms.f1.title': 'Avisos del coordinador',
    'comms.f1.text': 'Notificaciones a operarios sobre cambios de fecha, instrucciones o alertas de servicio.',
    ...
    'comms.f3.text': 'El CEO recibe resúmenes diarios y puede comunicarse con los coordinadores de cada país.',
    ...
    'sheet.edit.delete.confirm': '¿Eliminar "{name}"? Lo mando a la papelera (recuperable desde ahí en los próximos 30 días).',
    'sheet.edit.delete.error': 'Error al eliminar:',
    'sheet.edit.delete.blocked.completed': 'Los servicios completados no se pueden eliminar (son registro histórico). Solo se pueden modificar.',
    ...
    'relev.step.fotos.hint': '📷 Mostrá el área completa, accesos, riesgos y cualquier cosa relevante para cotizar.',
    'relev.step.notas.title': '📝 Notas para el comercial',
    'relev.step.notas.sub': 'Info adicional que el comercial necesita saber',
    'relev.step.notas.hint': '💡 Mientras más detalle, mejor cotización. Mencioná horarios preferidos, contactos en el lugar, accesos, etc.',
    ...
    'relev.notas.placeholder': 'Datos clave para que el comercial cotice: horarios, contactos, accesos, particularidades...',
    ...
    'porcobrar.contrato.body': 'Se vinculará la propuesta del contrato ({precio}/visita) a estas {n} visita(s):',
    'porcobrar.asociar.reconciliar': 'Este cobro está en otra moneda. ¿Querés marcar cuánto cubre del servicio?',
  ...
  'pt-BR': {
    ...
    'consent.body': 'Para usar o FlyClean você precisa aceitar nossos Termos de Uso e a Política de Privacidade.',
    ...
    'hist.sub': 'Os serviços em que você participou. Somente leitura — aqui nada pode ser alterado, só a sua nota.',
    'hist.mes': 'Este mês',
    'hist.total': 'Total',
    ...
    'eq.sincheck.banner': '{n} equipamentos sem check este mês — faça o ✅ Check e informe km/horas de cada um.',
    ...
    'ayuda.ph': 'Como faço…?',
    'ayuda.welcome': 'Olá! Sou seu assistente. Pergunte como fazer qualquer coisa no app e eu te guio passo a passo. 🙂',
    ...
    'eq.delete.hint': 'Sai da lista, recuperável por 30 dias. Para afastá-lo sem excluir, use o estado "Fora de serviço".',
    'eq.delete.confirm': 'Excluir "{name}" dos equipamentos. Vai para a lixeira (recuperável 30 dias). Excluir?',
    'hist.stat.contiempo': 'Com tempo registrado: {n} de {m} serviços.',
    'hist.stat.hint': 'O tempo é registrado quando o operador toca ▶ Iniciar e ao finalizar — serviços antigos sem esse registro não somam. 🚁 Drone usa o Método de trabalho do serviço.',
    ...
    'cfg.tar.hint': 'Preço de UMA diária (uma pessoa, um dia) por método. Multiplica-se pelas diárias do mês.',
    ...
    'cfg.tar.total': 'Total a pagar',
    'cfg.tar.paisnote': 'Soma todos os países do mês (moeda local). Ao ativar outro país será separado por moeda.',
    ...
    'calc.dron': 'Drone',
    'calc.manual': 'Manual',
    'calc.result': 'Preço sugerido para {m2} m² ({metodo}): {precio}\n\nFoi preenchido no valor (você pode ajustar).',
    ...
    'services.empty.text': 'Peça ao coordenador que atribua um serviço. Os serviços aparecem aqui quando o coordenador os atribui.',
    ...
    'cancelar.inicio.confirm': 'Cancelar o início do serviço? Você terá que iniciar novamente quando for o momento.',
    'cancelar.inicio.blocked': 'Você já registrou o início efetivo do trabalho. Não é possível cancelar (há dados do trabalho em andamento).',
    'close.need.resultado': 'Marque um resultado (Bem-sucedido / Com incidência / Falho) antes de fechar.',
    'close.prueba.need.resultado': 'Marque um resultado do teste (Avança / Não interessado / Re-contatar) antes de fechar.',
    ...
    'step.metodo.hint': 'Escolha como o trabalho é feito — pode marcar um ou ambos (drone e manual) e várias ferramentas. Obrigatório para registrar o início efetivo.',
    ...
    'sheet.edit.delete.confirm.completed': 'O serviço "{name}" está CONCLUÍDO (registro histórico). Excluir mesmo assim? Vai para a lixeira (recuperável 30 dias).',
    ...
    'wa.msg.prop': 'Olá{n}, falamos da FlyClean sobre o orçamento "{prop}". Conseguiu dar uma olhada? Qualquer dúvida estamos à disposição 🚁',
    'wa.msg.prospecto': 'Olá{n}, somos a FlyClean: limpeza de fachadas, vidros e painéis com drones. Podemos te contar como trabalhamos? 🚁',
    'coord.tab.pedidos': '📦 Pedidos',
    ...
    'tab.clientes': '👥 Clientes',
    'finanzas.tab.reportes': '📊 Relatórios',
    'finanzas.gastos.empty': '💸 Registre uma despesa com a foto do recibo — a IA (Claude) extrai os dados automaticamente.',
    ...
    'sheet.edit.section.participantes.hint': 'Marque os que estiveram no campo além do piloto. Cada um soma 1 jornal.',
    ...
    'sheet.edit.section.mapa': 'LINK GOOGLE MAPS',
    'sheet.edit.section.mapa.hint': "Cole o link do Google Maps (botão 'Compartilhar' → 'Copiar link'). O operário abre Maps/Waze direto.",
    'sheet.edit.jornada.title': '📅 Continuar como jornada',
    ...
    'sheet.contact.recontacto.hint': 'Até esta data o cliente não aparece em "para recontatar" nem nos alertas. Vazio = ciclo normal (9 meses).',
    'sheet.prop.section.posponer': '⏸ ADIAR AVISO ATÉ',
    'sheet.prop.posponer.hint': 'Até esta data a proposta não aparece em "Contatar hoje" nem é movida pelo robô. Vazio = ciclo normal (15/45 dias).',
    'coord.prop.pospuesta': 'Avisos adiados até {f}',
    'wa.msg.cliente': 'Olá{n}, falamos da FlyClean 🚁 Vamos combinar uma limpeza de fachada, vidros ou painéis? Estamos à disposição.',
    ...
    'prosp.confirm.cliente': 'Marcar este prospecto como Cliente ativo? Sai de Prospecção e passa para sua carteira de clientes.',
    ...
    'comms.sub': 'O sistema de mensageria interna entre CEO, coordenadores e operários está em desenvolvimento. Em breve poderão se comunicar diretamente pelo app.',
    ...
    'sheet.edit.delete.blocked.completed': 'Serviços concluídos não podem ser excluídos (são registro histórico). Apenas podem ser modificados.',
    ...
    'relev.step.fotos.hint': '📷 Mostre a área completa, acessos, riscos e qualquer detalhe relevante para cotizar.',
    'relev.step.notas.title': '📝 Notas para o comercial',
    'relev.step.notas.sub': 'Info adicional que o comercial precisa saber',
    'relev.step.notas.hint': '💡 Quanto mais detalhe, melhor a cotação. Mencione horários preferidos, contatos no local, acessos, etc.',
    ...
    'relev.notas.placeholder': 'Dados-chave para o comercial cotizar: horários, contatos, acessos, particularidades...',
    ...
    'porcobrar.contrato.body': 'A proposta do contrato ({precio}/visita) será vinculada a estas {n} visita(s):',
...
async function buildReportDoc(svc, extra = {}) {
  svc = svc || editingService;
...
async function generateReportPDF(svc, extra = {}) {
  svc = svc || editingService;
  if (!svc) return;
